        ...
        <section id="about" class="p-about c-section js-fadeInUpTrigger">
            ...
            <div class="p-about__wrap">
                ...
                <p class="p-about__intro">
                    はじめまして、西村壮哉と申します。
                    高知県出身の23歳です。この度は私が4月生まれということもあり、ポートフォリオサイトに桜を降らせてみました！
                    スポーツ歴＝年齢で大学もスポーツ系大学に通っていました。全国大会優勝チームのキャプテン経験などもあり、これまでかなり本格的にスポーツに取り組んできました。
                    大学4年生まで本気で体育の教員を目指していましたが、
                    読書などを通じて社会で通用するスキルを身につけたい！と考えるようになり、エンジニアを目指しました。
                </p>
            </div>
        </section>
        ...
        <section id="skill" class="p-skill c-section js-fadeInUpTrigger">
            <div class="c-section__container">
                ...
                <p class="c-section__description">
                    自分のスキルをグラフにしてみました。フロントエンドを厚めに学習しており、Vue.jsやReact.jsといったフレームワークも扱えます。<br>
                    バックエンドに関してもPHP に特化して学習し、フルスクラッチでの開発も行いました。<br>
                    フロント、バック共に学習することでWebサービス全体の流れを把握した上での開発が可能です。<br>
                    このような身につけたスキルをビジネスに活かし、より多くの人に価値を届けたいと思います。
                </p>
